...
function DeleteGame({deleteName}:Props){
    return(
        <Dialog>
        ...
        <DialogContent className="sm:max-w-[425px] bg-slate-950 text-white">
                <DialogHeader>
                    <DialogTitle className="text-red-500">カードゲームの削除</DialogTitle>
                    <DialogDescription>
                        あなたはカードゲーム「{deleteName}」を削除しようとしています。これは取り消すことができない操作です。本当に削除してよろしいですか?
                    </DialogDescription>
                </DialogHeader>
                <DialogFooter>
                    <DialogClose asChild>
